<?php
	...
	if ($usuario["id"] != -1) {
		$consulta = "SELECT USU_ID, USU_NOMBRE, USU_EMAIL, USU_TELEFONO1, USU_CALLE_NUMERO, USU_ESTADO, USU_CIUDAD, USU_COLONIA, USU_CP FROM USUARIO WHERE USU_ID = ?;";
		$pdo = $conexion->prepare($consulta);
	...
	CabeceraHTML("pagoInmueble.css,pagoInmueble.js", $variables);
	CuerpoHTML();
?>
<div class="pagoInmobiliaria_cuerpo">
	<p class="titulo">Pago de Inmueble</p><br /><br />
	<p><?php echo "Plan de Inmueble con vigencia al ".$partes[0]." de ".$arrayMeses[((int)$partes[1])-1]." del ".$partes[2]; ?></p><br /><br />
    <p class="total">Total: $<?php echo number_format($total, 2, ".", ","); ?></p><br /><br />
    <table <?php echo $usuario["id"] == -1 ? "style='display:none;'" :  ""; ?>>
        <tbody>
        	<tr>
            ...
            <tr>
            	<td style="padding-top:40px;">
                    <p id="btnGuardar" class="guardar" onclick="pago_validarCampos(<?php echo $idInmueble; ?>);"><a class="btnBotones palomita">Guardar</a>Pagar</p>
               	</td>
            </tr>
        </tbody>
    </table>
