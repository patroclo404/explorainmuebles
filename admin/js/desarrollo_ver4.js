		...
		divImagen.innerHTML = 
			"<table>"+
				"<tr>"+
					...
					"<td width='"+$("#template_nombreCampos").find("td").eq(1).width()+"' style='text-align:center;'>"+$("#tipo option[value='"+positions[pos][2]+"']").text()+"</td>"+
					"<td width='"+$("#template_nombreCampos").find("td").eq(2).width()+"' style='text-align:center;'><a href='javascript:desarrollo_abrirModificarImagenes("+pos+");'>Imágenes</a></td>"+
					"<td width='15'>"+
