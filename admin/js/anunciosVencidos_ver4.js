...
function mostrarCamposExistentes() {
	...
	for (var pos = 0; pos < positions.length; pos++) {
		...
		divImagen.innerHTML = 
			"<table>"+
				"<tr>"+
					"<td><a href='../inmueble.php?id="+positions[pos].id+"' target='_blank'>"+textTitulo+"</a></td>"+
					"<td width='"+$("#template_nombreCampos").find("td").eq(1).width()+"' style='text-align:center;'><a href='javascript:anunciosVencidos_abrirModificarUsuario("+pos+");'>"+textNombre+"</a></td>"+
					"<td width='"+$("#template_nombreCampos").find("td").eq(2).width()+"' style='text-align:center;'>"+positions[pos].id+"</td>"+
					"<td width='"+$("#template_nombreCampos").find("td").eq(3).width()+"' style='text-align:center;'>"+positions[pos].limiteVigencia+"</td>"+
					"<td width='"+$("#template_nombreCampos").find("td").eq(4).width()+"' style='text-align:center;'><a href='javascript:abrirModificarCampos("+pos+");'>Renovar</a></td>"+
					"<td width='15'>"+
