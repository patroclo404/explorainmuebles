		...
		divImagen.innerHTML = 
			"<table>"+
				"<tr>"+
					...
					"<td width='"+$("#template_nombreCampos").find("td").eq(4).width()+"' style='text-align:center;'>"+(parseInt(positions[pos].contAnuncios) > 0 ? ("<a href='inmueble.php?idUsuario="+positions[pos].id+"'>"+positions[pos].contAnuncios+"</a>") : positions[pos].contAnuncios)+"</td>"+
