		...
		divImagen.innerHTML = 
			"<table>"+
				"<tr>"+
					...
					"<td width='"+$("#main table.main_table tr").eq(2).find("td").eq(7).width()+"' style='text-align:center;'>"+$("#categoria option[value='"+positions[pos].categoria+"']").text()+"</td>"+
					"<td width='"+$("#main table.main_table tr").eq(2).find("td").eq(8).width()+"' style='text-align:center;'>"+$("#tipo option[value='"+positions[pos].tipo+"']").text()+"</td>"+
					"<td width='"+$("#main table.main_table tr").eq(2).find("td").eq(9).width()+"' style='text-align:center;'>"+positions[pos].codigo+"</td>"+
					"<td width='"+$("#main table.main_table tr").eq(2).find("td").eq(10).width()+"' style='text-align:center;'><a href='javascript:inmueble_abrirModificarTransacciones("+pos+");'>Transacción</a></td>"+
					"<td width='"+$("#main table.main_table tr").eq(2).find("td").eq(11).width()+"' style='text-align:center;'><a href='javascript:inmueble_abrirModificarImagenes("+pos+");'>Imágenes</a></td>"+
					"<td width='"+$("#main table.main_table tr").eq(2).find("td").eq(12).width()+"' style='text-align:center;'><a href='javascript:inmueble_abrirModificarVideos("+pos+");'>Videos</a></td>"+
					"<td width='15'>"+
