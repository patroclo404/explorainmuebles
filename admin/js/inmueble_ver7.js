...
/*
	Muestra u oculta los campos de tipo numerico dependiendo del valor recibido
		...
		* wcs:						[Float], es el numero de baños
...
function validarCampos () {
	...
	var arrayFlotantes = new Array("precio", "dimensionTotal", "dimensionConstruida", "wcs", "cuotaMantenimiento");
	var arrayEnteros = new Array("elevador", "estacionamientoVisitas", "numeroOficinas", "recamaras");
