...
function mostrarCamposExistentes(arrayContadores) {
	...
	for (var pos = 0; pos < positions.length; pos++) {
		...
		divImagen.innerHTML = 
			"<table>"+
				"<tr>"+
					"<td><a href='formularioInmueble.php?id="+positions[pos].id+"'>"+textTitulo+"</a></td>"+
...
function inmueble_inicializarBotones() {
	...
	$("#main table.main_table tr").eq(2).find("td").eq(0).find("img").attr("onclick", "gotoURL('formularioInmueble.php?id=-1');");
