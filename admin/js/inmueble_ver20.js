...
function inmueble_inicializarBotones() {
	$("#template_celdaBuscador").find("td").eq(0).append("<p style='padding-top:15px; padding-bottom:15px;'><a href='inmueble.php?publicados=1' style='margin-right:50px;'>Inmuebles publicados: <span id='_numPublicados'>0</span></a><a href='inmueble.php?nopublicados=1' style='margin-right:50px;'>Inmuebles no publicados: <span id='_numNoPublicados'>0</span></a><a href='inmueble.php?vencidos=1' style='margin-right:50px;'>Inmuebles vencidos: <span id='_numVencidos'>0</span></a><a href='inmueble.php?nopagados=1' style='margin-right:50px;'>Inmuebles no pagados: <span id='_numNoPagados'>0</span></a><a href='inmueble.php'>Total de inmuebles: <span id='_total'>0</span></a></p>");
...
function inmueble_popupIframe(posit) {
	...
	if (parseInt(pos_comp) == -1) {//nuevo
		...
		console.log(pos_comp,positions[pos_comp].propiedadDestacada );
		$("#crearAnuncio_propiedadesDestacadas").attr('checked', (positions[pos_comp].propiedadDestacada!== "0")?true:false );
