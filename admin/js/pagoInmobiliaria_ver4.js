		...
		divImagen.innerHTML = 
			"<table>"+
				"<tr>"+
					...
					"<td width='"+$("#main table.main_table tr").eq(1).find("td").eq(2).width()+"' style='text-align:center;'>"+positions[pos][6]+" - "+positions[pos][7]+"</td>"+
					"<td width='"+$("#main table.main_table tr").eq(1).find("td").eq(3).width()+"' style='text-align:center;'>"+$("#tipo option[value='"+positions[pos][5]+"']").text()+"</td>"+
					"<td width='"+$("#main table.main_table tr").eq(1).find("td").eq(4).width()+"' style='text-align:center;'>"+(positions[pos][4] == 1 ? "Si" : "No")+"</td>"+
					"<td width='"+$("#main table.main_table tr").eq(1).find("td").eq(5).width()+"' style='text-align:center;'>"+positions[pos][1]+"</td>"+
					"<td width='"+$("#main table.main_table tr").eq(1).find("td").eq(6).width()+"' style='text-align:center;'>"+positions[pos][3]+"</td>"+
					"<td width='15'>"+
