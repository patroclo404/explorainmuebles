...
function validarCampos () {
	var arrayCamposEvaluar = new Array("titulo", "vendedor", "categoria", "tipo", "precio", "calleNumero", "estado", "ciudad", "colonia", "latitud", "longitud", "codigo", "dimensionTotal", "dimensionConstruida", "dimensionUtil", "estadoConservacion", "amueblado", "cuotaMantenimiento", "elevador", "estacionamientoVisitas", "numeroOficinas");
	var arrayCamposObligatorios = new Array("titulo", "vendedor", "categoria", "tipo", "precio", "calleNumero", "estado", "ciudad", "colonia", "latitud", "longitud", "codigo", "estadoConservacion", "amueblado");
