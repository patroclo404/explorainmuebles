...
$(document).ready(function(){
	...
	$("#template_venta_colonia,#template_renta_colonia,#template_rentaVac_colonia,#template_busqueda_colonia").each(function(){
		var elemento = $(this);
...
function template_buscar_transaccion(transaccion) {
	...
	params2 =
			...
			"/"+($("#"+arrayTipoInmueble[indexTransaccion]).find("p").text() != "" ? $("#"+arrayTipoInmueble[indexTransaccion]).find("p").text() : "todos-los-tipos")+
