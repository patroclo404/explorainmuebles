...
$(document).ready(function(){
	...
	if (typeof post_categoria !== 'undefined') {
		...
		if (parseInt(post_desarrollo) != "") {
			$("#crearAnuncio_desarrollo li.lista li[data-value='"+post_desarrollo+"']").click();
			$("#crearAnuncio_desarrollo li.lista").hide();
		}
	}
...
function nuevoAnuncio_save() {
	...
	$("#_crearAnuncioDesarrollo").val($("#crearAnuncio_desarrollo p").attr("data-value"));
