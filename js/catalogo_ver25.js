					...
					"<tbody>"+
						"<tr>"+
							...
							"<td class='descripcion'>"+
								"<p class='like'>"+
									"<span onclick='gotoURL(\"inmueble.php?id="+json_datos.datos[x].id+"&regresar=1\");'>"+textTitulo+"</span>"+(parseInt(json_datos.datos[x].like) != -1 ? ("<a class='btnBotones estrella "+(parseInt(json_datos.datos[x].like) != 0 ? "activo" : "")+"' data-id='"+json_datos.datos[x].like+"' data-inmueble='"+json_datos.datos[x].id+"'>Like</a>") : "<a class='btnBotones estrella' data-id='"+json_datos.datos[x].like+"' data-inmueble='"+json_datos.datos[x].id+"'>Like</a>")+
								"</p>"+
								"<p class='btns'>"+
								...
								"<div class='info' onclick='gotoURL(\"inmueble.php?id="+json_datos.datos[x].id+"&regresar=1\");'>"+
									"<p>"+json_datos.datos[x].coloniaNombre+"</p>"+
