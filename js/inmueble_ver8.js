...
$(document).ready(function(){
		...
		click: function() {
			if (parseInt($("#inmueble_transaccion").find("p").attr("data-value")) > 0) {
				var data = {
					...
					wcs: $("#inmueble_wcs").find("p").attr("data-value"),
					recamaras: $("#inmueble_recamaras").find("p").attr("data-value")
				}
	...
	$(".contenedorInfo td.descripcion a.otrosBotones[data-label]").each(function(){
		var elemento = $(this);
