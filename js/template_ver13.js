...
function template_buscar_transaccion(transaccion) {
	...
	gotoURL("catalogo.php?transaccion="+datos.transaccion+"&tipoInmueble="+datos.tipoInmueble+"&estado="+datos.estado+"&ciudad="+datos.ciudad+"&colonia="+datos.colonia+"&codigo="+datos.codigo);
}
	...
	$("#template_busqueda_transaccion").each(function(){
		...
		$(this).find("li.lista li").on({
			click: function() {
				...
				$("#template_busqueda_precios_min li.lista li,#template_busqueda_precios_max li.lista li").hide();
				$("#template_busqueda_precios_min p,#template_busqueda_precios_max p").attr("data-value", -1);
				$("#template_busqueda_precios_min p,#template_busqueda_precios_max p").text("");
