<?php
	...
	$desactivar = isset($_POST["desactivar"]) ? 1 : 0;
	...
	*/
	...
	/*
		Desactiva el inmueble y regresa el limite vigencia al default: 2000-01-01
	*/
	if ($desactivar) {
		$consulta = "UPDATE INMUEBLE SET IMU_LIMITE_VIGENCIA = :limiteVigencia WHERE IMU_ID = :id;";
		$pdo = $conexion->prepare($consulta);
		$pdo->execute(array(":limiteVigencia" => "2000-01-01", ":id" => $id));
				...
				"<div style='width:700px; margin:0px; padding:0px; font-family:Arial, Helvetica, sans-serif;'>
					...
					<div style='background-color:#f6f6f6; padding:20px;'>
						<div style='border-width:4px; border-color:#852c2b; border-style:none solid; padding:10px 20px; color:#575756;'>
							<h1 style='font-size:22px; margin:0px 0px 15px 0px; color:#852c2b;'>Venta Anuncio Menor</h1><br />
							Se ha publicado un anuncio de venta menor a $500,000<br /><a href='http://www.explorainmuebles.com/inmueble.php?id=".$id_creado."' style='color:#852c2b; font-weight:bold; text-decoration:none;'>Ver anuncio</a>
						</div>
					</div>
		...
		if (($transaccion == 1) && ($precio <= 2500)) {//renta
			...
			$cadenaEmail = 
				"<div style='width:700px; margin:0px; padding:0px; font-family:Arial, Helvetica, sans-serif;'>
					...
					<div style='background-color:#f6f6f6; padding:20px;'>
						<div style='border-width:4px; border-color:#852c2b; border-style:none solid; padding:10px 20px; color:#575756;'>
							<h1 style='font-size:22px; margin:0px 0px 15px 0px; color:#852c2b;'>Renta Anuncio Menor</h1><br />
							Se ha publicado un anuncio de renta menor a $2,500<br /><a href='http://www.explorainmuebles.com/inmueble.php?id=".$id_creado."' style='color:#852c2b; font-weight:bold; text-decoration:none;'>Ver anuncio</a>
						</div>
					</div>
					<div style='text-align:center; padding:20px 0px;'>
						<a href='https://www.facebook.com/explorainmueblesmx' target='_blank' style='cursor: pointer; display: inline-block; height: 30px; overflow: hidden; text-align: left; vertical-align: top; width: 30px; margin: 0 10px; background: rgba(0, 0, 0, 0) url(\"http://www.explorainmuebles.com/images/botones.png\") no-repeat scroll -30px 0 / 390px 30px;'></a>
