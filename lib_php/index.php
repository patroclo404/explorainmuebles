...
<div class="index_cuerpo">
	<div class="galeria" data-width="<?php echo $medidas[0]; ?>" data-height="650<?php //echo $medidas[1]; ?>">
    	...
    	<div class="desplazamiento-cycle hidden-xs"><?php
            ...
            echo "<h2 class='text-banner'><span style='font-size: 37px;font-weight: 300;'>Explora Inmuebles</span><span style='text-transform: capitalize;font-weight: 300;font-size: 36px;background: rgb(132, 45, 44);'><br/>Tu propiedad en guadalajara</span></h2>";
    	?></div>
