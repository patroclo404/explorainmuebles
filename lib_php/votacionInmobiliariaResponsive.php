<?php
	...
	*/
    ...
    ';
		...
		if ($usuario != $propietario) {
			$html.=
				"<ul class='_contenedorEstrellas active calificacion' data-id='".$arrayVotacion["tuCalificacion"]["id"]."' data-calificacion='".$arrayVotacion["tuCalificacion"]["votacion"]."' data-inmobiliaria='".$id."'>
						<li>";
