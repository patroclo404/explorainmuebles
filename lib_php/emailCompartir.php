		...
		"<div style='width:700px; margin:0px; padding:0px; font-family:Arial, Helvetica, sans-serif;'>
			...
			<div style='background-color:#f6f6f6; padding:20px;'>
				<div style='border-width:4px; border-color:#852c2b; border-style:none solid; padding:10px 20px; color:#575756;'>
					<h1 style='font-size:22px; margin:0px 0px 15px 0px; color:#852c2b;'>Compartir Inmueble</h1>
					El usuario ".$nombre." te compartió el inmueble con la url: <a href='http://www.explorainmuebles.com/".$url."' target='_blank'>http://www.explorainmuebles.com/".$url."</a><br /><br />
					Mensaje: ".$mensaje."
				</div>
			</div>
